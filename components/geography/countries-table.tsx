...
interface CountriesTableProps {
	...
	onAction: (
		action: 'view_regions' | 'edit' | 'toggle_active',
		countryId: string,
	) => void;
}
...
export function CountriesTable({
	...
	const columns: ColumnDef<Country>[] = [
		...
		},
		{
			...
			header: 'Currency',
			cell: ({ row }) => (
				<span className='text-sm'>{row.original.currency_code}</span>
			),
		},
		{
			...
			header: 'Phone Prefix',
			cell: ({ row }) => (
				<span className='text-sm'>{row.original.phone_prefix}</span>
			),
		},
		{
					...
					<div onClick={(e) => e.stopPropagation()}>
						<DropdownMenu>
							...
							<DropdownMenuContent align='end'>
								...
								<DropdownMenuItem
									onClick={() =>
										onAction('view_regions', country.id)
									}
								>
								...
								<DropdownMenuItem
									onClick={() => onAction('edit', country.id)}
								>
								...
								{country.is_active ? (
									<DropdownMenuItem
										...
										onClick={() =>
											onAction('toggle_active', country.id)
										}
									>
