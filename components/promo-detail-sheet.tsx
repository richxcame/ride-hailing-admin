...
export function PromoDetailSheet({ promoId, open, onOpenChange, onUpdate }: PromoDetailSheetProps) {
				...
				<SheetHeader>
					<div className='flex items-center justify-between'>
						<div>
							...
							<SheetDescription>View usage statistics and manage promo code</SheetDescription>
						</div>
								...
								<AlertDialog>
									...
									<AlertDialogContent>
										<AlertDialogHeader>
											...
											<AlertDialogDescription>
												This will prevent users from using this promo code. This action
												can be reversed by editing the promo code.
											</AlertDialogDescription>
										</AlertDialogHeader>
										<AlertDialogFooter>
