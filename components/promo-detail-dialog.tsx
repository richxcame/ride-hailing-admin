...
export function PromoDetailDialog({ promoId, open, onOpenChange, onUpdate }: PromoDetailDialogProps) {
	...
	// The promo id we've already finished loading for; loading is derived from
	// "the open id doesn't yet match this" so we don't have to flip a loading
	// flag via setState inside the effect body.
